...
#ifndef P3_BinaryTree_h
#define P3_BinaryTree_h
#include "BNode.h"
...
namespace vcn {
    ...
    public:
        ...
        bool insertLeft(BNode<T> * parent, T value);
        bool insertRight(BNode<T> * parent, T value);
        bool insert(BNode<T> * parent, BNode<T> * value);
        bool insertLeft(BNode<T> * parent, BNode<T> * value);
        bool insertRight(BNode<T> * parent, BNode<T> * value);
    ...
    template <class T>
    bool BinaryTree<T>::insertLeft(BNode<T> * parent, T value)
    {
        BNode<T> * node = new BNode<T>(value);
        bool inserted = insertLeft(parent, node);
    ...
    template <class T>
    bool BinaryTree<T>::insertRight(BNode<T> * parent, T value)
    {
        BNode<T> * node = new BNode<T>(value);
        bool inserted = insertRight(parent, node);
    ...
    template <class T>
    bool BinaryTree<T>::insertLeft(BNode<T> * parent, BNode<T> * value)
    {
        bool inserted = false;
    ...
    template <class T>
    bool BinaryTree<T>::insertRight(BNode<T> * parent, BNode<T> * value)
    {
        bool inserted = false;
